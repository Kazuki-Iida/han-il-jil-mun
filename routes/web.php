...
Route::group(['middleware' => ['auth']], function(){
    ...
    Route::get('like/{question_id}/{id}', 'QuestionController@like')->name('question.like');
    Route::get('unlike/{question_id}{id}', 'QuestionController@unlike')->name('question.unlike');
});
